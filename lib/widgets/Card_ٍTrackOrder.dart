...
class Card_TrackOrder extends StatefulWidget {
  final String text1;
  ...
  @override
  _Card_TrackOrderState createState() => _Card_TrackOrderState();
}

class _Card_TrackOrderState extends State<Card_TrackOrder> {
  @override
