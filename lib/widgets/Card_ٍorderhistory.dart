...
class Card_orderhistory extends StatefulWidget {
  final String text1;
  ...
  @override
  _Card_orderhistoryState createState() => _Card_orderhistoryState();
}

class _Card_orderhistoryState extends State<Card_orderhistory> {
  @override
                      ...
                      Column(
                        children: [
                          IconButton(
                              ...
                              icon: Icon(Icons.delete_outline,color: HexColor('#D8DAE0')))
                        ],
                      )
                    ]),
                    SizedBox(height: 16),
