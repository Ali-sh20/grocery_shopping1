...
class Artboard55 extends StatefulWidget {
  const Artboard55({Key? key}) : super(key: key);

  @override
  _Artboard55State createState() => _Artboard55State();
}

class _Artboard55State extends State<Artboard55> {
